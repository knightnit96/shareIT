                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="addNews" action="<%=request.getContextPath() %>/admin/tin-tuc/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Tên bài viết</label>
                                                <input type="text" name="tenbaiviet" class="form-control border-input" placeholder="Nhập tên bài viết" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
